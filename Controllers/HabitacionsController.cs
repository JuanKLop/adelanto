...
namespace Glamping_Addventures.Controllers
{
    public class HabitacionsController : Controller
    {
        ...
        public HabitacionsController(GlampingAddventuresContext context)
        {
            _context = context;
        }
    ...
    .ToList();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            try
            {
                // Restaurar la cantidad de muebles antes de eliminar la habitación
            ...
            {
                ModelState.AddModelError("", "Ocurrió un error al intentar eliminar la habitación: " + ex.Message);
                return View("Delete", habitacion);
            }
        }
        [HttpPost]
