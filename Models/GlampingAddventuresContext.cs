...
//        => optionsBuilder.UseSqlServer("Server=MEDAPRCSGFSP681\\SQLEXPRESS;Initial Catalog=Glamping_Addventures;integrated security=True; TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Abono>(entity =>
        {
            entity.HasKey(e => e.Idabono).HasName("PK__Abono__8647F8A96F314D16");
        ...
        {
            entity.HasKey(e => e.NroDocumento).HasName("PK__Clientes__CC62C91CE8F71158");
        ...
        {
            entity.HasKey(e => e.IddetalleReservaPaquetes).HasName("PK__DetalleR__64F9FDAE9A3F8886");
        ...
        {
            entity.HasKey(e => e.IddetalleReservaServicio).HasName("PK__DetalleR__B52B22F88FDCBF41");
        ...
        {
            entity.HasKey(e => e.IdEstadoReserva).HasName("PK__EstadosR__3E654CA890FB70F3");
        ...
        {
            entity.HasKey(e => e.Idhabitacion).HasName("PK__Habitaci__6B4757DA4E436FF5");
        ...
        {
            entity.HasKey(e => e.IdhabitacionMuebles).HasName("PK__Habitaci__65CFCA9A1C1BB50D");
        ...
        {
            entity.HasKey(e => e.IdMetodoPago).HasName("PK__MetodoPa__6F49A9BE468727DB");
        ...
        {
            entity.HasKey(e => e.Idmueble).HasName("PK__Muebles__EAC9F7C85D13945E");
        ...
        {
            entity.HasKey(e => e.Idpaquete).HasName("PK__Paquetes__4C29513B447BAD0E");
        ...
        {
            entity.HasKey(e => e.Idpermiso).HasName("PK__Permisos__F11D75F3D6A90F61");
        ...
        {
            entity.HasKey(e => e.IdReserva).HasName("PK__Reserva__0E49C69D64D9F194");
        ...
        {
            entity.HasKey(e => e.Idrol).HasName("PK__Roles__A681ACB66CD78CE9");
        ...
        {
            entity.HasKey(e => e.IdrolPermiso).HasName("PK__RolesPer__3F09FABF48E87DB5");
        ...
        {
            entity.HasKey(e => e.Idservicio).HasName("PK__Servicio__3CCE7416AF26EACD");
        ...
        {
            entity.HasKey(e => e.IdtipodeHabitacion).HasName("PK__TipodeHa__9BD4086C6D5326D1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__TokenRec__3214EC073E55FD60");
        ...
        {
            entity.HasKey(e => e.Idusuario).HasName("PK__Usuarios__52311169EDB2D16F");
